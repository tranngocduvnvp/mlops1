        ...
        stage('Clone Repository') {
            steps {
                ...
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'mlops-test-token', url: 'https://github.com/tranngocduvnvp/AWS-ECS-Jenkins-ML-CICD.git']])
                }
            }
        }
        stage('Lint Code') {
